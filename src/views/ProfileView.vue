...
import AccountsTable from '@/features/accounts/components/AccountsTable.vue'
import ProfilesTable from '@/features/profile/components/ProfilesTable.vue'
import CategoriesTable from '@/features/categories/components/CategoriesTable.vue'
import CurrenciesTable from '@/features/currencies/components/CurrenciesTable.vue'
        ...
        <AccordionItem value="profiles" class="border rounded-xl bg-card px-4 border-border/50 shadow-sm overflow-hidden">
          <AccordionTrigger class="hover:no-underline py-4">
            <div class="flex items-center gap-3 text-card-foreground">
              ...
              <span class="font-semibold tracking-tight">{{ $t('profile.profiles') }}</span>
            </div>
          </AccordionTrigger>
        ...
        <AccordionItem value="accounts" class="border rounded-xl bg-card px-4 border-border/50 shadow-sm overflow-hidden">
          <AccordionTrigger class="hover:no-underline py-4">
            <div class="flex items-center gap-3 text-card-foreground">
              ...
              <span class="font-semibold tracking-tight">{{ $t('profile.accounts') }}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent class="border-t border-border/20 pt-4">
            <AccountsTable />
        ...
        <AccordionItem value="categories" class="border rounded-xl bg-card px-4 border-border/50 shadow-sm overflow-hidden">
          <AccordionTrigger class="hover:no-underline py-4">
            <div class="flex items-center gap-3 text-card-foreground">
              ...
              <span class="font-semibold tracking-tight">{{ $t('profile.categories') }}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent class="border-t border-border/20 pt-4">
            <CategoriesTable />
        ...
        <AccordionItem value="currencies" class="border rounded-xl bg-card px-4 border-border/50 shadow-sm overflow-hidden">
          <AccordionTrigger class="hover:no-underline py-4">
            <div class="flex items-center gap-3 text-card-foreground">
              ...
              <span class="font-semibold tracking-tight">{{ $t('profile.currencies') }}</span>
            </div>
          </AccordionTrigger>
          <AccordionContent class="border-t border-border/20 pt-4">
            <CurrenciesTable />
