...
import ProfileInfoModal from './ProfileInfoModal.vue'
...
const selectedInfoId = ref<string | null>(null)
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
              ...
              <span v-if="index === 0" class="text-[9px] text-muted-foreground uppercase font-black mt-1 opacity-50 tracking-wider">{{ $t('common.default') }}</span>
            </div>
          </div>
