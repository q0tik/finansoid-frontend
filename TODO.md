...
В этом компоненте я хочу добавить фильтры: выбрать счет (либо все), дейт-пикер дата/время от + дата/время до (НЕ ЗАБУДЬ ЧТО ЭТО ВСЕ МОБИЛЬНОЕ ПРИЛОЖЕНИЕ, ДОЛЖНО БЫТЬ УДОБНО!!! Может модалка?)